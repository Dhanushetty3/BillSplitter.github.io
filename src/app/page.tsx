...
export default function BillSplitter() {
  ...
  return (
    <main className={cn(
      ...
      <div className={cn(
        "transition-all duration-[4000] ease-in-out transform-gpu",
      ...
      {/* Header & Logo Section */}
      <div className={cn(
        "transition-all duration-[4000] transform-gpu ease-in-out flex flex-col items-center justify-center w-full z-50",
        isCenteredLayout ? "mb-0" : "h-auto mb-2"
      )}>
        <div className={cn(
          "flex flex-col items-center transition-all duration-[4000] transform-gpu",
          ...
          <p className={cn(
            "mt-3 text-sm md:text-base text-muted-foreground font-medium text-center transition-all duration-[2000]",
      ...
      {/* Main Content Reveal */}
      <div className={cn(
        "transition-all duration-[4000] transform-gpu flex flex-col w-full",
        ...
        {!isBillUploaded ? (
          <div className="max-w-xl mx-auto w-full py-2 space-y-4 animate-in fade-in duration-[4000]">
          ...
          <div className={cn(
            ...
            <div className={cn(
              "w-full space-y-6",
              showFullLayout ? "lg:col-span-4 animate-in slide-in-from-left-8 duration-[2000]" : "lg:max-w-lg"
            )}>
              ...
              {showFullLayout && (
                <>
                  <section className="bg-card rounded-2xl p-6 shadow-sm border border-border animate-in slide-in-from-bottom-6 duration-[1500] transition-all hover:shadow-md">
            ...
            {showFullLayout && (
              <div className="lg:col-span-8 animate-in slide-in-from-right-8 duration-[2000]">
