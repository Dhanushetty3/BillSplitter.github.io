                      ...
                      <div className="flex justify-between items-center text-sm">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <Input 
                            ...
                            className="w-24 h-8 text-right font-bold border-none bg-muted/30 focus-visible:ring-1 tabular-nums" 
                          />
                        </div>
                      </div>
                      <div className="flex justify-between items-center text-sm">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <Input 
                            ...
                            className="w-24 h-8 text-right font-medium border-none bg-muted/30 focus-visible:ring-1 tabular-nums" 
                          />
                        </div>
                      </div>
                      <div className="flex justify-between items-center text-sm">
                    ...
                    {splitMode === 'percentage' && (
                      <div className="space-y-6 animate-in fade-in duration-1000">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className={cn(
                            "text-xs font-bold px-4 py-1.5 rounded-full border transition-all duration-500 tabular-nums",
...
function PercentageInput({ value, onChange }: { value: number; onChange: (val: number) => void }) {
  ...
  return (
    <Input 
      className="w-24 text-right h-10 rounded-lg bg-muted/30 border-none focus-visible:ring-1 tabular-nums" 
      value={localValue}
